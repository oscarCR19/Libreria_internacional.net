<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MiCarrito.aspx.cs" Inherits="Libreria_internacional.net.Vistas.MiCarrito" %>
                ...
                <div class="column" style="float: left; width: 50%;">
                    <div style="width: 70px;">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link active" id="v-pills-messages-tab"  href="MiCarrito.aspx" role="tab" aria-controls="v-pills-messages" aria-selected="false" >Mi carrito</a>
